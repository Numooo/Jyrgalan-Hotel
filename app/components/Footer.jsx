    ...
    <footer className="bg-[#413328] text-[#feffff] pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h3
              className="text-2xl mb-4 text-[#eddfd4]"
              style={{ fontFamily: "Playfair Display, serif" }}
            >
              Jyrgalan Valley
            </h3>
            <p
              className="text-[#d6ccc2] mb-4"
              style={{ fontFamily: "Signika, sans-serif" }}
            >
              Experience authentic Kyrgyz hospitality in pristine alpine
              landscapes. Stay in our unique lodges and explore nature's
              wonders.
            </p>
          ...
          <div>
            ...
            <ul
              className="space-y-2 text-[#d6ccc2]"
              style={{ fontFamily: "Signika, sans-serif" }}
            >
              <li>Darya Hostel</li>
              ...
              >
                <li className="flex items-start text-[#d6ccc2]">
                  ...
                  <a
                    ...
                    className="text-[#d6ccc2] hover:underline"
                  >
                    {info.phone}
                  </a>
                </li>
