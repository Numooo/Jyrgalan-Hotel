...
export const useLoadingTestimonial = () =>
  useTestimonialStore((state) => state.loadingTestimonial);
export const useGetTestimonials = () =>
  useTestimonialStore((state) => state.getTestimonials);
export const useTestimonials = () =>
  useTestimonialStore((state) => state.testimonials);
export const useGetByIdTestimonial = () =>
  useTestimonialStore((state) => state.getByIdTestimonial);
export const useTestimonial = () =>
  useTestimonialStore((state) => state.testimonial);
export const useAddTestimonial = () =>
  useTestimonialStore((state) => state.addTestimonial);
export const useDeleteTestimonial = () =>
  useTestimonialStore((state) => state.deleteTestimonial);
export const useUpdateTestimonial = () =>
  useTestimonialStore((state) => state.updateTestimonial);
